...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', '100style', 'van_criekinge'], type=str,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml', '100style', 'van_criekinge']:
        cond_mode = 'text,age'
    else:
