...
def add_base_options(parser):
    ...
    group.add_argument("--cuda", default=True, type=lambda x: x.lower() not in ('false', '0', 'no'), help="Use cuda device, otherwise use CPU.")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', '100style', "vancriekinge"], type=str,
